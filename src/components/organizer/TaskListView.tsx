      ...
      <div className="p-4 border-b border-[var(--border)] bg-[var(--panel-bg)]/80 backdrop-blur sticky top-0 z-10">
        <div className="flex flex-wrap justify-between items-center gap-2 mb-4">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={() => onEditTask({ title: '', completed: false, orderIndex: tasks.length, createdAt: Date.now(), updatedAt: Date.now() })}
              className="bg-[var(--accent)] text-black rounded-lg px-3 py-1.5 text-xs font-bold flex items-center gap-1 shrink-0 whitespace-nowrap"
            >
